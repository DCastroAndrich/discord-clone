...
export const ChatItem = ({ id, content, member, timestamp, fileUrl, deleted, currentMenber, isUpdated, socketQuery, socketUrl }: ChatItemProps) => {
    ...
    const isAdmin = currentMenber.role === MemberRole.ADMIN
    const isModerator = currentMenber.role === MemberRole.MODERATOR
    const isOwner = currentMenber.id === member.id
    ...
    return (
        <div className="relative group felx items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="felx flex-col w-full">
                    ...
                    {isImage && (
                        <a href={fileUrl} target="_blank" rel="noopener noreferrer" className="relative aspect-square rounded-md mt-2 overflow-hidden border flex items-center
